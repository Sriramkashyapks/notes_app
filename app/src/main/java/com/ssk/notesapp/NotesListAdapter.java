...
class NotesListAdapter extends RecyclerView.Adapter<NotesListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NotesListAdapter.ViewHolder holder, int position) {
        ...
        String fileDisc = HelperUtils.readFile(file);

        holder.setData(fileName, fileDate, fileTime, fileDisc);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private final TextView noteTitle, noteDate, noteTime, noteDisc;
        ...
        void setData(String title, String date, String time, String disc) {
            stringTitle = title;
            noteTitle.setText(title);
            noteDate.setText(date);
            noteTime.setText(time);
            noteDisc.setText(disc);
        }
    }
